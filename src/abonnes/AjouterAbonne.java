...
public class AjouterAbonne extends JFrame {
    ...
    public AjouterAbonne(AbonneDAO abonneDAO) {
        ...
        // Titre
        JLabel titleLabel = new JLabel("Nouvel Abonné");
        ...
        saveButton.addActionListener(e -> {
            try {
                if (validateFields()) {
                    ...
                    abonne.setDateInscription(java.sql.Date.valueOf(LocalDate.now()));
